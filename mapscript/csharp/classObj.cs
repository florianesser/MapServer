...
public class classObj : IDisposable {
  ...
  internal classObj(IntPtr cPtr, bool cMemoryOwn) {
  ...
  public layerObj layer {
    get {
      ...
      layerObj ret = (cPtr == IntPtr.Zero) ? null : new layerObj(cPtr, false);
      if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public classObj(layerObj layer) : this(mapscriptPINVOKE.new_classObj(layerObj.getCPtr(layer)), true) {
  if (layer != null) this.swigCMemOwn = false;
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
}
  ...
  public styleObj getStyle(int i) {
    ...
    styleObj ret = (cPtr == IntPtr.Zero) ? null : new styleObj(cPtr, true);
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int insertStyle(styleObj style, int index) {
    int ret = mapscriptPINVOKE.classObj_insertStyle(swigCPtr, styleObj.getCPtr(style), index);
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
