...
public class layerObj : IDisposable {
  ...
  internal layerObj(IntPtr cPtr, bool cMemoryOwn) {
  ...
  public layerObj(mapObj map) : this(mapscriptPINVOKE.new_layerObj(mapObj.getCPtr(map)), true) {
  if (map != null) this.swigCMemOwn = false;
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
}
  ...
  public int insertClass(classObj classobj, int index) {
    int ret = mapscriptPINVOKE.layerObj_insertClass(swigCPtr, classObj.getCPtr(classobj), index);
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public classObj removeClass(int index) {
    ...
    classObj ret = (cPtr == IntPtr.Zero) ? null : new classObj(cPtr, true);
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public resultCacheObj getResults() {
    ...
    resultCacheObj ret = (cPtr == IntPtr.Zero) ? null : new resultCacheObj(cPtr, false);
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public rectObj getExtent() {
    ...
    rectObj ret = (cPtr == IntPtr.Zero) ? null : new rectObj(cPtr, true);
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
