...
public class symbolObj : IDisposable {
  ...
  internal symbolObj(IntPtr cPtr, bool cMemoryOwn) {
  ...
  public symbolObj(string symbolname, string imagefile) : this(mapscriptPINVOKE.new_symbolObj(symbolname, imagefile), true) {
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public lineObj getPoints() {
    ...
    lineObj ret = (cPtr == IntPtr.Zero) ? null : new lineObj(cPtr, true);
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
