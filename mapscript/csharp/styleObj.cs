...
public class styleObj : IDisposable {
  ...
  internal styleObj(IntPtr cPtr, bool cMemoryOwn) {
  ...
  public styleObj(classObj parent_class) : this(mapscriptPINVOKE.new_styleObj(classObj.getCPtr(parent_class)), true) {
  if (parent_class != null) this.swigCMemOwn = false;
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
}
