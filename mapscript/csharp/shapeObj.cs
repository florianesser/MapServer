...
public class shapeObj : IDisposable {
  ...
  internal shapeObj(IntPtr cPtr, bool cMemoryOwn) {
  ...
  public lineObj line {
    get {
      ...
      lineObj ret = (cPtr == IntPtr.Zero) ? null : new lineObj(cPtr, false);
      if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public shapeObj(int type) : this(mapscriptPINVOKE.new_shapeObj(type), true) {
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public pointObj getCentroid() {
    ...
    pointObj ret = (cPtr == IntPtr.Zero) ? null : new pointObj(cPtr, true);
    if (mapscriptPINVOKE.SWIGPendingException.Pending) throw mapscriptPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
