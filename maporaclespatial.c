 ...
 *****************************************************************************
 * $Id: maporaclespatial.c 6435 2007-08-01 18:16:13Z fsimon $
 *****************************************************************************
...
MS_CVSID("$Id: maporaclespatial.c 6435 2007-08-01 18:16:13Z fsimon $")
...
static int TRY( msOracleSpatialHandler *hand, sword status )
{
    ...
    switch (status)
    {
        case OCI_ERROR:
            ...
            break;
        case OCI_NEED_DATA:
            strcpy( (char *)hand->last_oci_error, "OCI_NEED_DATA" );
            break;
        case OCI_INVALID_HANDLE:
            strcpy( (char *)hand->last_oci_error, "OCI_INVALID_HANDLE" );
            break;
        case OCI_STILL_EXECUTING:
            strcpy( (char *)hand->last_oci_error, "OCI_STILL_EXECUTING");
            break;
        case OCI_CONTINUE:
            strcpy( (char *)hand->last_oci_error, "OCI_CONTINUE" );
            break;
        default:
            return 1; /* no error */
    }
...
static void osCircle(msOracleSpatialHandler *hand, shapeObj *shape, SDOGeometryObj *obj, int start, int end, lineObj points, pointObj *pnt, int data3d)
{
    ...
    if (n == 3)
    {
        ...
        {
            strcpy( (char *)hand->last_oci_error, "Points in circle object are colinear" );
            hand->last_oci_status = MS_FAILURE;
        }
    }
}
